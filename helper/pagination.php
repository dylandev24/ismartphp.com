...
function get_pagging($num_page, $page, $base_url = "")
{
    ...
    if ($page > 1) {
        $page_prev = $page - 1;
        $str_pagging .= "<li><a href=\"{$base_url}&page={$page_prev}\" data-id = '$page_prev'><i class='fa fa-angle-double-left'></i></a></li>";
    }
    ...
    if ($page < $num_page) {
        $page_next = $page + 1;
        $str_pagging .= "<li><a href=\"{$base_url}&page={$page_next}\" data-id = '$page_next'><i class='fa fa-angle-double-right'></i></a></li>";
    }
    $str_pagging .= "</ul>";
    return $str_pagging;
}
