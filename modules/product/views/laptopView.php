        ...
        <div class="secion" id="breadcrumb-wp">
            <div class="secion-detail">
                <ul class="list-item clearfix">
                    ...
                    <li>
                        <a href="danh-muc/laptop.html" class="cat_prd" id="laptop" title="">Laptop</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    ...
                    <div class="filter-wp fl-right">
                        <p class="desc">Hiển thị <?php echo num_row_laptop(); ?> trên <?php echo num_row(); ?> sản phẩm</p>
                ...
                <div class="section-detail">
                    <ul class="list-item clearfix filter_data" id="product-laptop">
            ...
            <div class="section" id="category-product-wp">
                ...
                <div class="secion-detail">
                    <ul class="list-item">
                        ...
                        <li>
                            <a href="danh-muc/laptop.html" class="cat_prd" id="1">Laptop</a>
                        </li>
                        <li class="disabled">
